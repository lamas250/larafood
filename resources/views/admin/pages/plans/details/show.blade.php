...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="{{route('details.plan.show',['url'=>$plan->url,'idDetail'=>$detail->id])}}" >Show</a></li>
</ol>
...
@section('content')
    <div class="card">
        ...
        <div class="card-footer">
            <form action="{{route('details.plan.delete',['url'=>$plan->url,'idDetail'=>$detail->id])}}" method="post">
                @csrf
                @method('DELETE')
